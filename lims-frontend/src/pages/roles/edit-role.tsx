...
export default function EditRolePage() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: "Roles & Permissions", href: "/roles" }, { label: "Edit Role" }])
  }, [])
    ...
    if (role) {
      ...
      setPermissions(
        modules.map((module) => {
          ...
          return existing || { module, canView: false, canCreate: false, canEdit: false, canDelete: false }
        })
      )
    } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Updated role:", { id, name: name.trim(), description: description.trim(), permissions })

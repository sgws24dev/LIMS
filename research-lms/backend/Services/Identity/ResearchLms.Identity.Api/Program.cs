...
using ResearchLms.Identity.Api.Middleware;
using ResearchLms.Infrastructure;
using ResearchLms.Infrastructure.Middleware;
using ResearchLms.Infrastructure.Persistence;
using ResearchLms.Identity.Application;
using ResearchLms.Identity.Infrastructure;
...
{
    c.SwaggerDoc("v1", new() { Title = "Research LMS - Identity Service", Version = "v1" });

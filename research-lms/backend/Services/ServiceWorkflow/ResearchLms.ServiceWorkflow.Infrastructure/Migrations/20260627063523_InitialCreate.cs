        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Transitions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Version = table.Column<int>(type: "int", nullable: false),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    EntityTypeHint = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormDefinitionVersion = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    ParentRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ApprovalRouting = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_FormDefinitions_FormDefinitionId",
                        column: x => x.FormDefinitionId,
                        principalTable: "FormDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_ServiceRequests_ParentRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateHistory = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Approvals_ServiceRequests_ServiceRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestMilestones_ServiceRequests_ServiceRequestId",
                        column: x => x.ServiceRequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Approvals_ApproverUserId_Status",
                table: "Approvals",
                columns: new[] { "ApproverUserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Approvals_ServiceRequestId_StepOrder",
                table: "Approvals",
                columns: new[] { "ServiceRequestId", "StepOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FormDefinitions_TenantId_Category",
                table: "FormDefinitions",
                columns: new[] { "TenantId", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_FormDefinitions_TenantId_Status",
                table: "FormDefinitions",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_NotificationRules_TenantId_WorkflowDefinitionId_Trigger",
                table: "NotificationRules",
                columns: new[] { "TenantId", "WorkflowDefinitionId", "Trigger" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestMilestones_ServiceRequestId_Order",
                table: "RequestMilestones",
                columns: new[] { "ServiceRequestId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_RequestStatusHistory_ServiceRequestId",
                table: "RequestStatusHistory",
                column: "ServiceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_FormDefinitionId",
                table: "ServiceRequests",
                column: "FormDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_ParentRequestId",
                table: "ServiceRequests",
                column: "ParentRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_TenantId_AssignedTo",
                table: "ServiceRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowDefinitions_TenantId_IsPublished_IsDeleted",
                table: "WorkflowDefinitions",
                columns: new[] { "TenantId", "IsPublished", "IsDeleted" });

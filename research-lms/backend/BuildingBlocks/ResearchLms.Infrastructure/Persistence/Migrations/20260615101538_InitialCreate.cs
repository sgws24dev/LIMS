        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateRef = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalibrationRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CalibrationRecord_Assets_InstrumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustodyEvent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustodyEvent_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRecord_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalibrationRecord_InstrumentId",
                table: "CalibrationRecord",
                column: "InstrumentId");

            migrationBuilder.CreateIndex(
                name: "IX_CustodyEvent_AssetId",
                table: "CustodyEvent",
                column: "AssetId");

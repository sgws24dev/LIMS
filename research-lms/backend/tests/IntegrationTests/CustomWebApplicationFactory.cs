...
public class CustomWebApplicationFactory : WebApplicationFactory<IdentityProgram>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddScoped<ICurrentUser>(_ =>
            {
                ...
                cu.SetUser(Guid.NewGuid(), "test@test.com", "Test", ["System Administrator"], Guid.Empty);
                return cu;
            });
        });
    }

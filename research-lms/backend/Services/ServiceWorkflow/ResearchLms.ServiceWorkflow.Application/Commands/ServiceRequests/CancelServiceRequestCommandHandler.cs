...
public class CancelServiceRequestCommandHandler : IRequestHandler<CancelServiceRequestCommand, ApiResponse<ServiceRequestDto>>
{
    ...
    public async Task<ApiResponse<ServiceRequestDto>> Handle(CancelServiceRequestCommand request, CancellationToken ct)
    {
        ...
        sr.Cancel(request.CancelledBy, request.Comment);

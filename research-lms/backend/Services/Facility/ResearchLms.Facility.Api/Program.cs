...
using ResearchLms.Facilities.Application;
using ResearchLms.Facilities.Infrastructure;
...
builder.Services.AddFacilityApplication();
builder.Services.AddFacilityInfrastructure();

builder.Services.AddControllers();
builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new() { Title = "Research LMS - Facility Service", Version = "v1" });
...
public partial class FacilityProgram { }
